  ...
  return (
    <AppBar position="fixed" background= "transparent">
      <Toolbar style={{minHeight: "80px"}}>
        ...
        <Typography variant="h5" className={classes.title} style={{fontSize: "32px",fontWeight: "800"}} >
        <img src="https://www.linkpicture.com/q/job-search.jpg" width="30px" height="auto"></img>Find JOBS
        </Typography>
